...
export function listBuildingFloors(buildingId?: string | number) {
...
export function listBuildingCellShapes(buildingId?: string | number) {
...
/** List floor cells */
export function listFloorCells(floorId: string | number) {
...
export function resetGridExtras(building_id: string | number) {
